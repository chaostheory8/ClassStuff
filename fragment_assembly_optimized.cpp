...
int find_max_seq_loc()
{
    ...
    int temp = 0;
    int result;
    for(int seq_iter = 0; seq_iter<master_size; seq_iter++)
	{
        for(int comp_iter = 0; comp_iter<master_size; comp_iter++)
        {
...
int main()
{
    ...
    for(int seq_iter = 0; seq_iter<master_size; seq_iter++)
	{
        ...
        for(int seq_iter2 = 0; seq_iter2<master_size; seq_iter2++)
        {
    ...
    for(int loc_int = 0; loc_int < master_size; loc_int++)
    {
        ...
        else
        {
            ...
            for(int seq_iter = 0; seq_iter<master_size; seq_iter++)
            {
                for(int comp_iter = 0; comp_iter<master_size; comp_iter++)
                {
                    ...
                    {
                        string seq_string = sequences.at(seq_iter);
                        string frag = defrag(seq_iter, comp_iter, seq_string);
                        if(frag != seq_string && frag != results.at(results.size()-1))
                        {
